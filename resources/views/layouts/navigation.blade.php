                ...
                @auth
                    <x-dropdown align="right" width="64">
                        <x-slot name="trigger">
                            <button
                                class="flex items-center justify-center w-10 h-10 rounded-full
                                       ...
                                       text-white font-semibold hover:ring-2 hover:ring-cyan-300">
                                @if(Auth::user()->avatar)
                                    <img
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link :href="route('student.mycourses')">
                                My Learning
                            </x-dropdown-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-700">
            ...
            <div class="mt-4 space-y-1">
                <x-responsive-nav-link :href="route('student.mycourses')">
                    My Learning
                </x-responsive-nav-link>
