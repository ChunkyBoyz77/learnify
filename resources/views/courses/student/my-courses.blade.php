<x-app-layout>
  <x-slot name="header">
    <div class="flex items-center justify-between">
        {{-- Match font and leading exactly with Explore page --}}
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('My Learning Journey') }}
        </h2>

        {{-- Reduced padding (py-1) and smaller text (text-xs) to keep the header slim --}}
        <div class="hidden sm:flex items-center gap-2 text-xs font-bold text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-800 px-3 py-1 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm">
            ...
            <span class="uppercase tracking-wider">{{ $courses->count() }} Enrolled</span>
        </div>
    </div>
  </x-slot>
