            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div class="lg:col-span-4 xl:col-span-3">
                    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 sticky top-6">
                        ...
                        <div class="p-4 border-t border-gray-100 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-700/10">
                            <a href="{{ route('courses.edit', $course->id) }}" class="text-sm font-bold text-teal-600 dark:text-teal-400 hover:underline flex items-center gap-1">
