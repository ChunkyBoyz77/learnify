<nav x-data="{ open: false }" class="bg-gradient-to-r from-teal-50 to-cyan-50 dark:from-gray-900 dark:to-gray-800 border-b border-teal-200 dark:border-gray-700 shadow-sm">
        ...
        <div class="flex justify-between h-20">
            <div class="flex">
                ...
                <div class="hidden space-x-2 sm:-my-px sm:ms-10 sm:flex items-center">
                    ...
                    <!-- Explore Courses -->
                    <x-nav-link :href="route('courses.index')" :active="request()->routeIs('courses.index')" class="px-4 py-2 rounded-lg transition-all hover:bg-teal-100 dark:hover:bg-gray-700">
                        <svg class="w-5 h-5 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    @auth
                        @php
                            // FIXED MY COURSE route names:
                            $myCourseRoute = auth()->user()->role === 'instructor'
                            ? route('courses.my')        
                            : route('student.mycourses'); 
                        @endphp

                        <x-nav-link :href="$myCourseRoute" :active="request()->routeIs('courses.instructor.my') || request()->routeIs('courses.student.my')" class="px-4 py-2 rounded-lg transition-all hover:bg-teal-100 dark:hover:bg-gray-700">
                            <svg class="w-5 h-5 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <x-nav-link :href="route('feedbacks.index')" :active="request()->routeIs('feedbacks.*')" class="px-4 py-2 rounded-lg transition-all hover:bg-teal-100 dark:hover:bg-gray-700">
                            <svg class="w-5 h-5 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <!-- My Course -->
            @auth
                <x-responsive-nav-link :href="$myCourseRoute" :active="request()->routeIs('courses.instructor.my') || request()->routeIs('courses.student.my')">
                    {{ __('My Courses') }}
                </x-responsive-nav-link>
